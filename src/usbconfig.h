 ...
 */
#define USB_CFG_VENDOR_NAME     'J', 'P', 'E', 'W'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'C', '6', '4', 'U', 'S', 'B'
...
#define USB_CFG_DESCR_PROPS_HID_REPORT              (USB_PROP_IS_RAM | USB_PROP_LENGTH(USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH))
